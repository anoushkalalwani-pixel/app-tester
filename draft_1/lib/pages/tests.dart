...
class UserTests extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Tests', style: GoogleFonts.nunito(color: colors.onSurface)),
        backgroundColor: colors.surface, // Darker blue for app bar
      ),
      body: Container(
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      color: colors.surface, // Dark blue for test boxes
